...
Como este notebook utiliza alguns gráficos da biblioteca *Plotly*, cuja interatividade se perde no *Github*, eu deixo aqui <a href="https://www.kaggle.com/code/lusfernandotorres/vendas-de-jogos-de-videogames">um link para acessar este notebook no Kaggle</a>, onde os gráficos *Plotly* são totalmente interativos.
